...
class _$ScoreDao extends ScoreDao {
  _$ScoreDao(
    ...
    this.changeListener,
        ...
        _scoreDataModelInsertionAdapter = InsertionAdapter(
            database,
            'score',
            (ScoreDataModel item) => <String, Object?>{
                  'id': item.id,
  ...
  final InsertionAdapter<ScoreDataModel> _scoreDataModelInsertionAdapter;
